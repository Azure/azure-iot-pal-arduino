...
void due_sample_init(byte *mac, const int rand_pin);
    ...
    else
    {
        ...
        switch(reason){
            case IOTHUB_CLIENT_CONNECTION_EXPIRED_SAS_TOKEN:
                LogInfo("Reason EXPIRED_SAS_TOKEN  %i\n",reason);
                break;
            case IOTHUB_CLIENT_CONNECTION_DEVICE_DISABLED: 
                LogInfo("Reason DEVICE_DISABLED  %i\n",reason);
                break;            
            case IOTHUB_CLIENT_CONNECTION_BAD_CREDENTIAL:   
                LogInfo("Reason BAD_CREDENTIAL  %i\n",reason);
                break;         
            case IOTHUB_CLIENT_CONNECTION_RETRY_EXPIRED:    
                LogInfo("Reason RETRY_EXPIRED  %i\n",reason);
                break;          
            case IOTHUB_CLIENT_CONNECTION_NO_NETWORK:       
                LogInfo("Reason NO_NETWORK  %i\n",reason);
                break;          
            case IOTHUB_CLIENT_CONNECTION_COMMUNICATION_ERROR:         
                LogInfo("Reason COMMUNICATION_ERROR  %i\n",reason);
                break;
            case IOTHUB_CLIENT_CONNECTION_OK:                  
                LogInfo("Reason CONNECTION_OK  %i\n",reason);
                break;         
            case IOTHUB_CLIENT_CONNECTION_NO_PING_RESPONSE:     
                LogInfo("Reason NO_PING_RESPONSE  %i\n",reason);
                break;  
        }
...
void setup() {
   ...
   IOTHUB_CLIENT_TRANSPORT_PROVIDER protocol = HTTP_Protocol;
    ...
    due_sample_init(assigned_mac,RAND_PIN);
